---
title: Contributing
description: Guide to contributing to SREGym - development setup, code style, and contribution process
---
...
1. Read the [README](https://github.com/SREGym/SREGym/blob/main/README.md) to understand the project
2. Review the [Problem Set](https://docs.google.com/spreadsheets/d/1FGIeLNcKsHjrZGQ_VJcQRGl6oTmYyzjW0_ve5tfM_eg/edit?usp=sharing)
...
5. Set up your cluster (see [Quick Start](/docs/quick-start) for options)
...
1. **Create problem file** in `sregym/conductor/problems/<problem-name>.py`:
   ...
   class MyProblem(Problem):
       def __init__(self):
           ...
           self.root_cause = "root cause description in natural language"
...
- **Documentation**: Check the [README](https://github.com/SREGym/SREGym/blob/main/README.md) and existing documentation

### Staying Updated

- Watch the repository for updates
- Follow discussions on Slack
- Review the problem set for new additions

## License

By contributing to SREGym, you agree that your contributions will be licensed under the [MIT License](https://github.com/SREGym/SREGym/blob/main/LICENSE.txt).
